	...
	<div class="container">
		...
		<section class="articulo-g main row"> <!-- row necesario para dividir la fila del a seccion en columnas -->
			...
			<article class="col-xm-12 col-sm-7 col-md-8 col-lg-8 "> <!-- md=mediano otros(xm,sm,md,lg) col-md-offset-3=mueve 3 espacios la culumna-->
				...
				<br>
				<p class="text-justify">Clínica Las Americas es una entidad prestadora de salud, cuyo principal objetivo es entregar a nuestros pacientes y familias una atención integral, resolutiva y oportuna basada en la calidez, compromiso y los más altos estándares de calidad.</p>
			...
			<div class="col-xm-12 col-sm-4 col-md-3 col-lg-3 col-md-offset-1 col-sm-offset-1">
				...
				<div id="botones-inicio">
				<a href="#" title="Especialidades" class="botones" id="boton-4"></a>
				</div>
				</div>
